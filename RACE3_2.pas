...
begin
 setcolor(c);
 line(x,y,x-10,y+5);
 line(x-10,y+5,x-30,y+8);
 line(x-30,y+8,x-50,y+10);
 line(x-50,y+10,x-47,y);
 line(x-47,y,x-63,y-5);
 line(x-63,y-5,x-70,y+5);
 line(x-70,y+5,x-60,y+25);
 line(x-60,y+25,x-63,y+27);
 line(x-63,y+27,x-100,y+5);
 line(x-100,y+5,x-105,y);
 line(x-105,y,x-90,y-10);
 line(x-90,y-10,x-85,y-20);
 line(x-85,y-20,x-95,y-25);
 line(x-95,y-25,x-90,y-35);
 line(x-90,y-35,x-70,y-50);
 line(x-70,y-50,x-50,y-55);
 line(x-50,y-55,x-47,y-52);
 line(x-47,y-52,x-53,y-40);
 line(x-53,y-40,x-47,y-35);
 ellipse(x-48,y-15,0,90,40,40 div 2);
 line(x,y,x-8,y-15);
 line(x-8,y-15,x-37,y-20);
 line(x-37,y-20,x-40,y-25);
 line(x-40,y-25,x-12,y-24);
 setfillstyle(1,c);
 floodfill(x-5,y-5,c);
 setfillstyle(1,1);
 floodfill(x-20,y-23,c);

 setcolor(cf);
 line(x-90,y-10,x-95-sf,y-17);
 line(x-95,y-25,x-95-sf,y-17);

 line(x-90,y-10,x-95-round(sf*0.25),y-17);
 line(x-95,y-25,x-95-round(sf*0.25),y-17);
 setfillstyle(9,cf);
 floodfill(x-95-round(sf*0.5),y-17,cf);
end;
...
begin
 ...
 setcolor(8);
 printText('versiya 1.02',x+30,y+25);
end;
...
procedure programming(var money: integer; {var mods: array of integer;} sx,sy,sc: array of integer);
var
 exit,onbutton: boolean;
 button,ir,buty: integer;
 t: string;
begin
 onbutton:=false;
 exit:=true;
 ...
 while exit do
 begin
  if buty>3 then buty:=1;
  if buty<1 then buty:=3;

  if button>6 then button:=1;
  if button<1 then button:=6;
  ...
  case button of
   2:
	  case buty of
     1:begin
		  printText('bonus 3',55,105); printText('1000 rub.',55,115);
     end;
     2:begin
		  printText('bonus 3',55,105); printText('4000 rub.',55,115);
     end;
     3:begin
		  printText('bonus 5',55,105); printText('6000 rub.',55,115);
     end;
    end;
   {3:
   4:
  ...
  if button=1 then printMish(75,75);

  setcolor(2);
  if (button=2) and (buty=1) then setcolor(4);
  printText('usilitelx sd100',105,50);
  setcolor(2);
  if (button=2) and (buty=2) then setcolor(4);
  printText('usilitelx sl200',105,60);
  setcolor(2);
  if (button=2) and (buty=3) then setcolor(4);
  printText('usilitelx sk300',105,70);


  setcolor(2);
  if (button=3) and (buty=1) then setcolor(4);
  printText('nasadka kfd40',255,50);
  setcolor(2);
  if (button=3) and (buty=2) then setcolor(4);
  printText('nasadka kfd70',255,60);
    setcolor(2);
  if (button=3) and (buty=3) then setcolor(4);
  printText('nasadka gfd100',255,70);


  setcolor(2);
  if (button=4) and (buty=1) then setcolor(4);
  printText('modifikator ppt-09',400,50);
  setcolor(2);
  if (button=4) and (buty=2) then setcolor(4);
  printText('modifikator rpr-30',400,60);
  setcolor(2);
  if (button=4) and (buty=3) then setcolor(4);
  printText('modifikator tfr-900',400,70);

  setcolor(2);
  if (button=5) and (buty=1) then setcolor(4);
  printText('remontnaya sistema gen-1000',205,150);
  setcolor(2);
  if (button=5) and (buty=2) then setcolor(4);
  printText('nitrogeterator nos-30',205,160);
  setcolor(2);
  if (button=5) and (buty=3) then setcolor(4);
  printText('fuelgeterator ful-6.7',205,170);

  setcolor(2);
  if (button=6) and (buty=1) then setcolor(4);
  printText('hakkerskaya sistema hak 1.1',205,200);
  setcolor(2);
  if (button=6) and (buty=2) then setcolor(4);
  printText('hakkerskaya sistema hak 1.4',205,210);
  setcolor(2);
  if (button=6) and (buty=3) then setcolor(4);
  printText('komp. virus radio-chervx',205,220);
...
begin
  ...
  setcolor(2);
  printText('igrok '+t,round(getMaxX/2)-25,round(getMaxY/2)-25-10);
  printText('nazhmite enter',round(getMaxX/2)-25,round(getMaxY/2)-25-3);
  readln;
  cleardevice;
...
begin
 ...
 while exit=false do begin
  ...
  if onbutton then begin
   ...
   if button=6 then programming(money,sx,sy,sc);
  end;
  onbutton:=false;
 end;
end;
...
begin
 ...
 begin
  ...
  if comw[2]=18 then begin printText('bonus +50000 rub.',2,12); mon[2]:=mon[2]+500; end;
 end;
